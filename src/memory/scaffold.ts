...
- \`maxRepairCycles\`: consecutive non-improving ERC/DRC checks tolerated before rollback (default 5); a check whose violation count is shrinking never counts, and any improvement resets the streak
