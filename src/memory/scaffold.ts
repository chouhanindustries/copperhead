...
- \`maxRepairCycles\`: consecutive non-improving ERC/DRC attempts before rollback (default 5); the first failing check and checks with fewer violations establish progress rather than spending the budget
