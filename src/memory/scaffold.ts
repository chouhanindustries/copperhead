...
- \`commitRunArtifacts\`: commit each run's transcript/metrics/summary (and, for \`create\`, the stage report) as their own commits (default true) — see runs/ below
...
\`transcript.jsonl\`, \`metrics.json\`, and \`summary.md\` are force-added and
