...
- The default utilization fraction and minimum readable pitch: pick starting values during implementation and tune against the fixtures and the first real runs, rather than guessing them here.
