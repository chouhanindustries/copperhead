...
Let GitHub draft the body from the merged PRs, then edit it:
    ...
    gh api repos/chouhanindustries/copperhead/releases/generate-notes \
...
<!-- One bullet per merged PR, in the generated format:
     ...
     * <PR title> by @<author> in https://github.com/chouhanindustries/copperhead/pull/<n>

     Generation only sees PRs. A change pushed straight to main has no bullet,
     so add it by hand and link the commit instead:

     * <commit subject> by @<author> in https://github.com/chouhanindustries/copperhead/commit/<sha>
...
<!-- Generated. Delete this section when there are none.
     ...
     * @<user> made their first contribution in https://github.com/chouhanindustries/copperhead/pull/<n> -->

**npm:** https://www.npmjs.com/package/copperhead/v/<x.y.z>

**Full Changelog**: https://github.com/chouhanindustries/copperhead/compare/v<previous>...v<x.y.z>
